 ...
 *
 * <p>Класс использует аннотации:</p>
 * <ul>
 *     <li>{@link RestController} - для обозначения класса как контроллера REST;</li>
 *     <li>{@link RequestMapping} - для указания базового пути для всех методов контроллера;</li>
 *     <li>{@link AllArgsConstructor} - для автоматической генерации конструктора с параметрами.</li>
 * </ul>
 */
@RestController
