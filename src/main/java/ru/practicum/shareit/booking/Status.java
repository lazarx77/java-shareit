 ...
 * </ul>
 *
 * <p>Это перечисление используется для управления состоянием бронирований в системе и
 * позволяет легко отслеживать и изменять статус бронирования в зависимости от действий
 * пользователей и системы.</p>
 */
public enum Status {
    WAITING,
    APPROVED,
